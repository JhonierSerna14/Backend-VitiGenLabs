"""
VitiGenLabs Backend FastAPI Application

This module defines the main FastAPI application for the VitiGenLabs backend.
It provides REST API endpoints for genetic analysis of grape varieties,
including user authentication, file upload, and gene search functionality.
"""
